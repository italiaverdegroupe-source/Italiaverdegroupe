...
export const BLOCKS = {
  'home.hero.kicker.from': { group: 'Homepage', label: 'Hero kicker, origin', kind: 'line',
    where: 'Small line above the headline', fallback: 'Italy' },
  'home.hero.kicker.to': { group: 'Homepage', label: 'Hero kicker, destination', kind: 'line',
    where: 'Small line above the headline', fallback: 'United Arab Emirates' },
  ...
  'home.hero.cta': { group: 'Homepage', label: 'Main button', kind: 'line',
    where: 'The first button. {n} is replaced by the number of specimens.',
    fallback: 'Browse {n} specimens' },
  ...
  'home.coverage.title': { group: 'Homepage', label: 'Coverage, heading', kind: 'line',
    where: 'Lower half of the homepage', fallback: 'All seven emirates.' },
