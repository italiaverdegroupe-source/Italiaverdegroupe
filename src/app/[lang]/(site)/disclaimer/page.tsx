...
export async function generateMetadata(
  ...
  return { ...meta, alternates: alternates(lang, '/disclaimer') };
}
        ...
        },
        {
          ...
          body: (
            <p>
              ...
              <L href="/terms-of-sale">terms of sale</L>, and what happens when
              one arrives wrong or fails is on the{' '}
              <L href="/refunds">replacements and refunds policy</L>. Neither
