    ...
    <div className="section">
      <div className="wrap">
        ...
        <ul className="coll">
          {families.map((f, i) => (
            <li key={f.slug}>
              <Link href={`/collections/${f.slug}`} className="coll-card">
        ...
        <section className="coll-cta">
          ...
          <div className="coll-cta-acts">
            <Link href="/catalog" className="btn btn-primary">Search the catalogue</Link>
            <Link href="/quote" className="btn btn-ghost">Send a specification</Link>
          </div>
        </section>
      </div>
