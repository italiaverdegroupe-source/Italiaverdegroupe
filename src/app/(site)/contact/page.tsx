...
export const generateMetadata = (): Promise<Metadata> => metadataFor('/contact', {
  title: 'Contact',
  description:
  ...
  return (
    <div className="section">
      <div className="wrap">
        ...
        {channels.length > 0 ? (
          ...
          <p className="ct-none">
            ...
            every day — <Link href="/quote">send it here</Link> and we will come
      ...
      <style>{`
        ...
        .ct-list { margin: 0 0 1.6em; padding-left: 1.1em; color: var(--fg-soft); }
